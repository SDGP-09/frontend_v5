...
// }
//
// // Optional: map nav item text to a target URL.
...
//                                 <a className="inline-flex items-center px-6 py-2 border border-white/30 bg-white/10 backdrop-blur-sm text-sm font-medium rounded-full text-white hover:bg-gradient-to-r hover:from-green-500 hover:to-blue-500 hover:border-transparent hover:shadow-lg hover:shadow-blue-500/20 transition-all">
//                                     LOGIN
//                                 </a>
//                             </Link>
//                         </motion.div>
...
//                                     <a className="block">
//                                         <motion.span
//                                             className="block w-full px-4 py-3 bg-gradient-to-r from-green-500 to-blue-500 text-center text-base font-medium rounded-md text-white hover:from-green-600 hover:to-blue-600 transition-colors shadow-lg shadow-blue-500/20"
