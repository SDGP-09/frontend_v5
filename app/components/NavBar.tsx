                ...
                <div className="flex items-center justify-between h-20">
                    ...
                    <div className="hidden lg:flex lg:items-center lg:space-x-6">
                        ...
                        >
                            <Link
                                href="/login"
                                className="inline-flex items-center px-6 py-2 border border-white/30 bg-white/10 backdrop-blur-sm text-sm font-medium rounded-full text-white hover:bg-gradient-to-r hover:from-green-500 hover:to-blue-500 hover:border-transparent hover:shadow-lg hover:shadow-blue-500/20 transition-all"
                            >
                                LOGIN
                            </Link>
                        </motion.div>
