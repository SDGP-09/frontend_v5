...
// Service Tab component for navigation
    ...
    const services: ServiceItem[] = [
        {
            ...
            image: "https://res.cloudinary.com/ddcbr53w0/image/upload/v1742411680/standard-quality-control-concept-m_23-2150041844_fonlge.avif",
            icon: (
            ...
            features: ["Secure Access control","User Role Management", "Permission  Settings",  "Data Privacy Compliance"],
            link: "/service"
        },
        {
            title: "INTER PLATFORM MESSAGING",
            description: "Keep your team connected with real-time messaging across all platforms.",
            image: "https://res.cloudinary.com/ddcbr53w0/image/upload/v1742412624/representations-user-experience-interface-design_23-2150038906_voyjwd.jpg",
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6">
            ...
            features: ["Real-Time messaging and communication", "Instant Updates", "File Sharing and Read Receipts"],
            link: "/service"
        },
        {
            title: "CONSTRUCTION EXCELLENCE",
            description: "Building with precision and expertise, ensuring quality craftsmanship in every project we undertake.",
            ...
            features: ["Continuous improvement features to uphold high construction standards", "company-based authentication","Project Management", "Inter-platform messaging", "Tender-management"],
            link: "/services"
        },
        {
            title: "TENDER MANAGEMENT",
            description: "Simplify your tender process with our advanced management system.",
            image: "https://res.cloudinary.com/ddcbr53w0/image/upload/v1742413160/close-up-financial-report_1098-2701_ixesrp.jpg",
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6">
        ...
        },
        {
            ...
            description: "Comprehensive planning and management services to ensure your project proceeds smoothly from concept to completion.",
            image: "https://res.cloudinary.com/ddcbr53w0/image/upload/v1742412933/business-woman-talking-about-financial-project-taking-notes-discussing-start-up-ideas-using-laptop-diverse-employees-gathered-co-working-working-process-busy-company-teamwork-help-concept_482257-13564_csy7we.avif",
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6">
            ...
            features: ["Efficient Planning", "Real-Time Progress Tracking", "Resource Allocation", "Deadline Management", "Seamless Collaboration"],
            link: "/services"
        },

    ];

    // Generate glow dots for background
    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                {/* Green-blue glow dots for background */}
                {glowDots.map((dot, i) => (
                    <motion.div
                        key={i}
            ...
            <div ref={sectionRef} className="container mx-auto px-4 relative z-10">
                {/* Section Header with Animated Parts */}
                <div className="max-w-4xl mx-auto mb-16 text-center relative">
                    ...
                    >
                        ...
                        <span className="inline-block px-4 py-1 bg-gradient-to-r from-green-500 to-blue-500 text-white rounded-full text-xs font-semibold tracking-widest uppercase mb-4">Our Services</span>
              ...
              <span className="relative inline-block mr-3">
                ...
                />
                            ...
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500">Solutions</span>
                        </h2>
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        >
                            <div className="flex flex-col lg:flex-row gap-12">
                                {/* Left: Service Image with Parallax Effect */}
                                <motion.div
                                ...
                                >
                                    {/* Image with Parallax */}
                                    <ParallaxImage src={services[activeServiceIndex].image} speed={0.3} />
                                ...
                                >
                                            ...
                                            {services[activeServiceIndex].features?.map((feature, idx) => (
                                                ...
                                                >
                                                    <motion.div
                                                        ...
                                                        animate={{
                                                            scale: [1, 1.2, 1],
                                                            backgroundColor: ["rgba(16, 185, 129, 0.2)", "rgba(59, 130, 246, 0.4)", "rgba(16, 185, 129, 0.2)"]
                                                        }}
                                                        transition={{ duration: 3, repeat: Infinity, delay: idx * 1.2 }}
                                                    >
                                    ...
                                    <motion.div variants={itemVariants}>
                                        <MagneticButton className="inline-block">
                                            <div className="relative px-8 py-4 bg-gradient-to-r from-green-500 to-blue-500 text-white font-bold rounded-xl shadow-lg shadow-blue-500/20 overflow-hidden group">
                                                {/* Moving light effect */}
                                                <motion.div
                ...
                <div className="relative">
                    <motion.div
                        ...
                        transition={{ duration: 0.6 }}
                    >
                        {services.filter((_, i) => i !== activeServiceIndex).slice(0, 4).map((service, index) => (
                            <motion.div
                                key={service.title}
                                className="w-80 flex-shrink-0 cursor-pointer"
                                whileHover={{ y: -10 }}
                                onClick={() => setActiveServiceIndex(services.findIndex(s => s.title === service.title))}
                                initial={{ opacity: 0, y: 20 }}
                                animate={{ opacity: 1, y: 0 }}
                            ...
                            >
                                <div className="relative rounded-2xl overflow-hidden bg-gray-800 h-44 group">
                                    ...
                                    <div className="absolute inset-0 w-full h-full">
                                        <img src={service.image} alt={service.title} className="w-full h-full object-cover opacity-60 group-hover:opacity-40 transition-opacity" />
                                    </div>

                                    {/* Green-blue Overlay on Hover */}
                                    <div className="absolute inset-0 bg-gradient-to-r from-green-500 to-blue-500 opacity-0 group-hover:opacity-30 transition-opacity"></div>

                                    {/* Content */}
                                    <div className="absolute inset-0 p-6 flex flex-col justify-between">
                                        <div className="flex justify-between items-start">
                                            <h3 className="text-sm font-bold text-white max-w-[80%]">{service.title}</h3>
                    ...
                    {/* Scroll indicator */}
                    {/*<motion.div */}
                    {/*  className="hidden md:flex absolute -bottom-2 right-4 text-cyan-400 items-center space-x-2 text-sm"*/}
                    {/*  initial={{ opacity: 0 }}*/}
                    {/*  animate={{ opacity: 1 }}*/}
                            ...
                            <div className="relative z-10 flex flex-col lg:flex-row items-center text-center lg:text-left">
                                <div className="lg:w-3/4 mb-8 lg:mb-0 lg:pr-12">
                                    <motion.h3
                                        ...
                                        transition={{ duration: 0.6 }}
                                    >
                                        Ready to Transform Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500">Vision</span> into Reality?
                                    </motion.h3>
                                    <motion.p
                                ...
                                <div className="lg:w-1/4">
                                    {/*<MagneticButton>*/}
                                    {/*  <div*/}
                                    {/*      className="relative px-8 py-4 bg-gradient-to-r from-green-500 to-blue-500 text-white font-bold rounded-xl shadow-xl shadow-blue-500/20 overflow-hidden group">*/}
                                    {/*    /!* Shine Effect *!/*/}
                                    {/*    <motion.div*/}
                                    ...
                                    {/*    /!*  </motion.svg>*!/*/}
                                    {/*    /!*</span>*!/*/}
                                    {/*    <a href="/service" className="relative z-10 flex items-center">*/}
                                    {/*      Get Started*/}
                                    {/*      <motion.svg*/}
                                    {/*          className="ml-2 w-5 h-5"*/}
                                    {/*          fill="none"*/}
                                    ...
                                    {/*  </div>*/}
                                    {/*</MagneticButton>*/}
                                    <MagneticButton href="/service">
                                        <div className="relative px-8 py-4 bg-gradient-to-r from-green-500 to-blue-500 text-white font-bold rounded-xl shadow-xl overflow-hidden group">
                                            <motion.div
                                                className="absolute inset-0 bg-gradient-to-r from-transparent via-white to-transparent opacity-0 group-hover:opacity-30"
                                                initial={{ x: '-100%' }}
                                                whileHover={{ x: '100%' }}
