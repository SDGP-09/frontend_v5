                    ...
                    <div className="max-w-7xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div
                                ...
                                className="group bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-all duration-300">
                                <div className="text-center">
                                    <Hammer
                                        className="w-12 h-12 mx-auto text-green-500 mb-4 transition-transform duration-300 group-hover:scale-110"/>
                                    ...
                                    <button
                                        className="bg-gradient-to-r from-green-400 to-blue-500 text-white px-6 py-2 rounded-md hover:from-green-500 hover:to-blue-600 transition-all duration-300 shadow-sm hover:shadow-md">
                                        Search Contractors
                                    </button>
                                </div>
                            </div>
                            ...
                            <div
                                ...
                                <div className="text-center">
                                    <Users
                                        className="w-12 h-12 mx-auto text-blue-500 mb-4 transition-transform duration-300 group-hover:scale-110"/>
                            ...
                            <div
                                onClick={() => router.push("/application/project-management")}
                                className="group bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-all duration-300">
                                <div className="text-center">
                                    <FileSpreadsheet
                                        className="w-12 h-12 mx-auto text-green-500 mb-4 transition-transform duration-300 group-hover:scale-110"/>
