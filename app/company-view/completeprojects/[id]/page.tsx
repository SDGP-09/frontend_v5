...
//
// // Dummy data for completed projects (without privacy/visibility properties)
// const dummyCompletedProjects: completeprojects[] = [
//     {
//         id: "1",
//         title: "Urban Renewal District",
//         description:
...
// export default function CompletedProjectProfilePage() {
//     const { id } = useParams();
//     const projectId = id ? id.toString() : "1"; // Default to "1" if no id provided
//
//     const [projectData, setProjectData] = useState<completeprojects | null>(null);
//     const [isLoading, setIsLoading] = useState<boolean>(true);
//     const isInitialMount = useRef<boolean>(true);
//
//     // Simulate fetching dummy data based on the project id
...
export default function Page() {
    ...
    // Type the project data using completeprojects
    const [projectData, setProjectData] = useState<completeprojects | null>(null);
    const [isLoading, setIsLoading] = useState<boolean>(true);
    const isInitialMount = useRef<boolean>(true);
